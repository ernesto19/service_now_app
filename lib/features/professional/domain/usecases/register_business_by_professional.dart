...
class RegisterBusinessByProfessional implements UseCase<RegisterBusinessResponse, RegisterBusinessParams> {
  ...
  Future<Either<Failure, RegisterBusinessResponse>> call(RegisterBusinessParams params) async {
    return await repository.registerBusiness(params.name, params.description, params.industryId, params.categoryId, params.licenseNumber, params.jobOffer, params.latitude, params.longitude, params.address, params.fanpage);
  }
}
...
class RegisterBusinessParams extends Equatable {
  ...
  RegisterBusinessParams({ @required this.name, @required this.description, @required this.industryId, @required this.categoryId, @required this.licenseNumber, @required this.jobOffer, @required this.latitude, @required this.longitude, @required this.address, @required this.fanpage });
