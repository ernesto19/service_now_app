...
class ProfessionalBusinessGalleryAddPage extends StatefulWidget {
  final int id;

  const ProfessionalBusinessGalleryAddPage({ @required this.id });

  @override
  _ProfessionalBusinessGalleryAddPageState createState() => _ProfessionalBusinessGalleryAddPageState();
}

class _ProfessionalBusinessGalleryAddPageState extends State<ProfessionalBusinessGalleryAddPage> {
  ...
  Widget _buildSaveButton() {
    return RoundedButton(
      ...
      onPressed: () {
        ...
        bloc.agregarImagenesNegocio(widget.id, images);
        bloc.agregarImagenNegocioResponse.listen((response) {
          if (response.error == 0) {
            ...
            showDialog(
              ...
              builder: (context) {
                return AlertDialog(
                  ...
                  content: Text(allTranslations.traslate('imagenes_agregadas'), style: TextStyle(fontSize: 16.0),),
                  actions: <Widget>[
                    FlatButton(
